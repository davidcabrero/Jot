        ...
        private void InitializeLocalizedStrings()
        {
            _localizedStrings = new Dictionary<string, Dictionary<string, string>>
            {
                ...
                ["es"] = new Dictionary<string, string>
                {
                    ...
                    ["EmailWarning"] = "Para Gmail/Outlook, puede que necesites activar 'Acceso de apps menos seguras' o usar una contraseña de aplicación.",
                ...
                ["ca"] = new Dictionary<string, string>
                {
                    ...
                    ["SMTPServer"] = "Servidor SMTP",
                    ["EmailWarning"] = "Per a Gmail/Outlook, pot ser que necessitis activar 'Accés d'apps menys segures' o fer servir una contrasenya d'aplicació.",
                ...
                ["ast"] = new Dictionary<string, string>
                {
                    ...
                    ["ToEmail"] = "Pa (Email)",
                    ["FromEmail"] = "De (Email)",
                    ["SendMethod"] = "Métodu d'Unviamientu",
                    ["DefaultEmailClient"] = "Cliente de Correau Predetermináu",
                    ["CustomSMTP"] = "SMTP Personalizáu",
                    ["EmailFormat"] = "Formatu",
                    ["PlainText"] = "Testu Planu",
                    ["Password"] = "Contraseña",
                    ["SMTPServer"] = "Servidor SMTP",
                    ["EmailWarning"] = "Pa Gmail/Outlook, quiciabes necesites activar 'Accesu d'apps menos segures' o usar una contraseña d'aplicación.",
                    ["EmailSentSuccess"] = "¡Email unviáu correchu!",
